...
const coachSidebarData = [
  ...
  { title: 'Plans',          route: `/plans`,       line: false, active: true, Icon: <GrappleIcon src='/settings-light.svg' variant='light' /> },
...
function PlansLayout({ children, role, profile, notifications, gym }: any) {
  return (
    <DefaultDashboard
