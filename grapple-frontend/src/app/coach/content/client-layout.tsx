...
const coachSidebarData = [
  ...
  { title: 'Content',        route: `/content`,     line: false, active: true, Icon: <GrappleIcon src='/content-light.svg' variant='light' /> },
...
export default CoachContentLayout;
