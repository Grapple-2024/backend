...
const coachSidebarData = [
  ...
  { title: 'Billing',        route: `/billing`,     line: false, active: true, Icon: <GrappleIcon src='/settings-light.svg' variant='light' /> },
...
function BillingLayout({ children, role, profile, notifications, gym }: any) {
  return (
    <DefaultDashboard
